...
export default Designer.extend({
    ...
    props: [{
        ...
        key: 'useCNStyle',
        ifShow: data => Magix.config('cnTableText') && data.supportCNStyle,
        type: PropsDesc.BOOLEAN,
        refresh: true,
    ...
    icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60"><path style="stroke:#fff;stroke-width:2" d="M 15 20 L 45 20 M 17 31 L 30 31 M 15 40 L 38 40" /></svg>`
});