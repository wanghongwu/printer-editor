...
const ElementsCompare = ({ props: a }, { props: b }) => a.zIndex - b.zIndex;
export default {
    '@{element.center}'(rect) {
        return {
    ...
    '@{get.sorted.elements}'(elements) {
        let copy = this['@{get.pure.elements}'](elements);
        return copy.sort(ElementsCompare);
    },
